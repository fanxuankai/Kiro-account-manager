import { Home, Users, Settings, Info, ChevronRight, Fingerprint, Sparkles, Server, Shield, UserPlus, CreditCard, ScrollText, Network, Bell, Stethoscope, Archive, Warehouse, Receipt, KeyRound, Chrome } from 'lucide-react'
...
export type PageType = 'home' | 'accounts' | 'idleAccounts' | 'machineId' | 'kiroSettings' | 'proxy' | 'kproxy' | 'proxyPool' | 'register' | 'loginPool' | 'googlePool' | 'subscription' | 'billing' | 'webhooks' | 'diagnose' | 'configSync' | 'logs' | 'settings' | 'about'
