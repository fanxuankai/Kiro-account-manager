import { Home, Users, Settings, Info, ChevronRight, Fingerprint, Sparkles, Server, Shield, UserPlus, CreditCard, ScrollText, Network, Bell, Stethoscope, Archive, Warehouse, Receipt } from 'lucide-react'
...
export type PageType = 'home' | 'accounts' | 'idleAccounts' | 'machineId' | 'kiroSettings' | 'proxy' | 'kproxy' | 'proxyPool' | 'register' | 'subscription' | 'billing' | 'webhooks' | 'diagnose' | 'configSync' | 'logs' | 'settings' | 'about'
